...
<head>
    ...
    <link rel="stylesheet" href="/css/01-layout/09-work/style.css">
</head>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="card col-12 col-md-6 col-lg-4 active layout">
                        <img src="/img/01-layout/09-work/01.png" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-4 active layout">
                        <img src="/img/01-layout/09-work/02.png" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-4 active JavaScript">
                        <img src="/img/01-layout/09-work/03.png" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-4 active JavaScript">
                        <img src="/img/01-layout/09-work/04.png" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-4 active work">
                        <img src="/img/01-layout/09-work/05.png" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-4 active work">
                        <img src="/img/01-layout/09-work/06.png" class="card-img-top" alt="...">
                        <div class="card-body">
