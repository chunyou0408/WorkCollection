...
@section('main')
<h1 style="text-align: center;margin-top: 30px;">float-04</h1>
<a href="/01-layout/float" class="next_btn" style="float: right">回列表</a>
<div style="clear: both"></div>
<a href="/01-layout/float/03" class="next_btn" style="float: left">上一個</a>
<a href="/01-layout/float/05" class="next_btn" style="float: right">下一個</a>
<div style="clear: both"></div>
<!-- 巢狀結構 -->
